...
4. [How to monitor my service and receive alert if something goes wrong?](4_monitoring_alerting/README.md)
5. [How to use IoT Analytics Dataset to train a machine learning model?](5_machine_learning/README.md)